...
class TaskInstance(Base, LoggingMixin):
    ...
    def xcom_pull_params(self, task_ids="tapd", dag_id=None):
        """Fetch XCOM hashes that match a dag and exec date
        ...
        print('xcom_pull_params -> pull_fn:')
        print(str(type(pull_fn)))
        print(str(dir(pull_fn)))
        print(str(pull_fn.args))

        return { x.key: x.value for x in pull_fn() }
